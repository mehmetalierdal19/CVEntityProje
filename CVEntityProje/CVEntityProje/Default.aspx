...
<html lang="zxx">
<head>
    <title>Yazılım CV Yetenek Sitesi</title>
        ...
        <section class="wedo" id="contact">
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat="server">
                    ...
                    <asp:TextBox TextMode="MultiLine" ID="txtMesaj" runat="server" placeholder="Mesajınız" required=""></asp:TextBox>
                    <asp:Button ID="btnGonder" runat="server" Text="Gönder" CssClass="btn btn-info" OnClick="btnGonder_Click" />
                    <asp:Button ID="btnVazgec" runat="server" Text="Vazgeç" CssClass="btn btn-warning ml-2" OnClick="btnVazgec_Click" />
                    <div class="clearfix"></div>
                </form>
            </div>
            <div class="cpy-right text-center">
                <p>
                    © 2022 Design by Mehmet Ali Erdal
                </p>
            </div>
        </section>
        <!-- //contact -->
